...
set.seed(1)
dat <- read_csv(file = "~/Downloads/Indian Liver Patient Dataset (ILPD).csv",
...
```{r shap-plots, results = params$answers, fig.show='hide'}
...
## The second plot basically shows the same relationships, but in a somewhat 
## different (and more detailed!) way.
```
