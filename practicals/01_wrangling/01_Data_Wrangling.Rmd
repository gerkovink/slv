...
output: 
  html_document:
    ...
    theme: paper
    highlight: pygments
    pandoc_args: --output=01_Data_Wrangling_Answers.html
---
...
- hand in the zip file before the start of the next lecture on Wednesday 13:15 to Blackboard ("PRACTICAL: DATA MANIPULATION & EDA").