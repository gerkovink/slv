...
| 04-Nov | 9 am | [Ruppert D](https://goo.gl/maps/ZL959UVy7ne8bRMD7) |
...
### Assignment
Students will form groups to choose work on two assigments. Students will need to perform calculations and program code for these assigments. All work needs to be combined in an easy understandable, self-contained and insightful `RStudio` project (zipped - and in `.Rmd`) and must be submitted to the [Course submission GitHub page]((https://surfdrive.surf.nl/files/index.php/s/LqUCEt3MWVsW7DF). Each assigment will be graded. 
