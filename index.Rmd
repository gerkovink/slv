...
- [Practical 4: Regression with code solutions](practicals/04_Regression/01_Regression_answers.html)
...
- [ISLR V2 Chapter 4](https://web.stanford.edu/~hastie/ISLR2/ISLRv2_website.pdf)
...
- [Practical 7: Classification evaluation Evaluation](practicals/07_classification_evaluation/07_classification_evaluation.html)
...
- [ISLR V2 Chapter 4 (if you haven't done so yet) + 8.1](https://web.stanford.edu/~hastie/ISLR2/ISLRv2_website.pdf)
